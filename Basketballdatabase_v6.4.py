        ...
        if Password != 'NbaStar23':
            ...
            while True:
                ...
                if userinput == '0':
                    ...
                    cursor.execute('select * from players, Championships where players.ChampionshipNumber_ID = Championships.ChampNumber_ID')
                    result = cursor.fetchall()
                        #print the information nicely formated
                    for tidy in result:
            ...
            while True:
                ...
                if userinput == '0':
                    ...
                    result = cursor.fetchall()
                        #print the information nicely formated
                    for tidy in result:
                        print(f"{tidy[2]:<21}{tidy[10]:<22}{tidy[11]:<4}")
                elif userinput == '9':
                        #this is the first query option
                    db = sqlite3.connect(DATABASE)
                    cursor = db.cursor()
